...
Catalogo de las Mejores empresa en el Departamento de Escuintla
	...
	<section class="posts">
		<article class="post">
			...
			<?php
		$re=mysql_query("select * FROM anuncios WHERE estado = 'A' and idnegocio = ".$_GET['id'])or die(mysql_error());
		while ($f=mysql_fetch_array($re)) {
		?>
			<div class="producto">
				<center>
					<span><?php echo $f['empresa'];?></span>
				<img src="./anuncios/<?php echo $f['imagenes'];?>"><br>
				<span>Dirección: <?php echo $f['direccion'];?></span><br>
				<span>Telefono: <?php echo $f['telefono'];?></span><br>
				<!-- <a href="./detalleUnidad.php?id=<?php  echo $f['idanuncio'];?>&negocio=<?php  echo $f['empresa'];?>">ver</a> -->
				</center>
			</div>
			<?php
		}
